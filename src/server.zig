...
pub const read_stream = @import("server/read_stream.zig");
...
pub const Server = struct {
    ...
    pub const probeThinkingGate = autonomic.probeThinkingGate;
    pub const handleProbeAutonomic = autonomic.handleProbeAutonomic;
    pub const handleTaskTriage = autonomic.handleTaskTriage;
    pub const handleTaskTitle = autonomic.handleTaskTitle;
    pub const handleBacklogTriage = autonomic.handleBacklogTriage;
    ...
    pub const handleReadStreamOpen = read_stream.handleReadStreamOpen;
    pub const handleReadStreamClose = read_stream.handleReadStreamClose;
