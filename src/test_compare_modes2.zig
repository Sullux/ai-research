...
fn testMode(allocator: std.mem.Allocator, mode: quant.QuantMode, mode_name: []const u8) !void {
...
pub fn main() !void {
    ...
    try testMode(allocator, .q8, "Q8_0");
    try testMode(allocator, .q4, "Q4 (K-Quant Affine)");
}
