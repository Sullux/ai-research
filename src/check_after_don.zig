...
pub fn main() !void {
    ...
    const gen_prefix = [_]u32{
        100, 45518, 107, 818, 2430, 563, 10980, 623, 3910, 659, 611, 3490, 3124, 126584, 1174, 563, 496, 4077, 653, 10841, 236772, 136809, 2934, 236761, 1773, 614, 12498, 236764, 564, 1537,
    };
    ...
    std.debug.print("Top 10 logits after \"... I don\":\n", .{});
    for (all[0..10]) |item| {
